...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(center, radius - 30.0, outlineBrush);
    ...
    var minuteHandX = centerX + 85 * cos(dateTime.minute * 6 * pi / 180);
    var minuteHandY = centerY + 85 * sin(dateTime.minute * 6 * pi / 180);
    canvas.drawLine(center, Offset(minuteHandX, minuteHandY), minuteHandBrush);

    var secondHandX = centerX + 100 * cos(dateTime.second * 6 * pi / 180);
    var secondHandY = centerY + 100 * sin(dateTime.second * 6 * pi / 180);
    canvas.drawLine(center, Offset(secondHandX, secondHandY), secondHandBrush);

    canvas.drawCircle(center, 15.0, centerFillBrush);
